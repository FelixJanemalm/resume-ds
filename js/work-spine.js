...
const SIM_SHARED = `
    ...
    vec3 flowLocal(vec3 q, vec4 md, float role, out float fade){
      ...
      if (wake > 0.5) {
        ...
        q.y = ${WATERLINE} + swellAt(x, q.z) * (1.0 - uSwell.z);   // at rest the specks lie still: no swell heave

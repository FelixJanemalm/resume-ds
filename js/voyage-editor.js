...
export function mountRouteEditor(api) {
    ...
    const LEVERS = [
        ...
        ['ship', [['shipHeelWind', 'wind heel (deg)', 0, 25, 0.5], ['shipBob', 'motion (pitch/heave/roll)', 0, 3, 0.05], ['shipSway', 'scene sway at anchor', 0, 3, 0.05], ['shipSoft', 'soft ship at anchor', 0, 1, 0.05], ['shipDotsRest', 'dot size at rest (x field)', 1, 2.2, 0.05], ['shipFlap', 'sail flutter', 0, 3, 0.05], ['shipSettle', 'settle speed (/s)', 1, 20, 0.5], ['shipLean', 'banking (deg per deg/s)', -0.2, 0.2, 0.005]]],
